...
/// struct MyStruct {
///     a: u8,
///     pub __pad1: [u8; const { core::mem::offset_of!(__MyStruct__, b) - core::mem::offset_of!(__MyStruct__, a) - core::mem::size_of::<u8>() }],
///     b: u32,
///     pub __pad2: [u8; const { core::mem::size_of::<__MyStruct__>() - core::mem::offset_of!(__MyStruct__, b) - core::mem::size_of::<u32>() }],
/// }
/// ```
///
...
pub fn padding_struct(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    for (i, field) in field_vec.iter().enumerate() {
        ...
        // Extract cfg attributes from the current field
        let cfg_attrs: Vec<_> = field_attrs
            .iter()

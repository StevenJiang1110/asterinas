...
fn test_repr_align_preserved() {
    ...
    assert_eq!(core::mem::align_of::<__AlignedStruct__>(), 16);
    ...
    let aligned = AlignedStruct {
        ...
        b: 2,
        __pad2: [0; {
            core::mem::size_of::<__AlignedStruct__>()
                - core::mem::offset_of!(__AlignedStruct__, b)
                - core::mem::size_of::<u32>()
        }],
    };
...
fn test_size_align_match() {
    ...
    assert_eq!(
        core::mem::size_of::<TestStruct>(),
        core::mem::size_of::<__TestStruct__>()
    );
    assert_eq!(
        core::mem::align_of::<TestStruct>(),
        core::mem::align_of::<__TestStruct__>()
    );
}

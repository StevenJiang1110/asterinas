...
impl MountStatsFileOps {
    pub fn new_inode(dir: &TidDirOps, parent: Weak<dyn Inode>) -> Arc<dyn Inode> {
        // Reference: <https://elixir.bootlin.com/linux/v6.17/source/fs/proc/base.c#L3385>
    ...
    ///
    /// Linux always emits a generic header line for every visible mount and then lets the
    /// filesystem append extra statistics when it supports them. Asterinas currently only
    /// supports the generic VFS line.
    fn read_mount_stats(
        &self,
